...
基于 [Dayflow](https://dayflow.so/) 的设计理念，为 Windows 时间管理应用 **知时** 打造的极简现代单页展示站点。

## ✨ 项目亮点

- **Dayflow 风格复刻**：承袭暗色渐层、玻璃拟态与柔和动效，呈现 Mac 应用级的高级质感。
- **双语内容切换**：提供中英文文案，支持一键切换，满足不同受众需求。
...
- **HTML5**：语义化结构，分区明确。
- **CSS3**：CSS 变量、Flexbox、Grid、渐层与玻璃拟态实现视觉风格。
...
> 如需进一步自定义品牌视觉（如 logo、色彩或插画），可替换 `assets/images` 内资源，并根据需要调整 `:root` 中的 CSS 变量。
